...
namespace QuanLyBanThuoc
{
    public partial class Đặt_Hàng : Form
    {
        ...
        private void Add_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                if (txtIDDH.Text == ""||txtNG.Text==""||txtSL.Text == "")
                {
                ...
                if (dbUpdateDH != null)
                {
                    ...
                    DialogResult dr = MessageBox.Show("Mã đặt hàng trùng. Chọn Yes để Cập Nhật!", "Thông Báo", MessageBoxButtons.YesNo);
                                        ...
                                        if (itam.TENTHUOC == cmbMT.Text) 
                                        {
                                            foreach (var tam in listNV)
                                                if (tam.HOTENNV == cmbNV.Text)
                                                {
                                                    ...
                                                    {
                                                        throw new Exception("Số Lượng Vượt Quá Số Lượng Đang Có Trong Thuốc !\n --Xin Vui Lòng Nhập Lại");
                                                    }
                                                    else
                                                    {
